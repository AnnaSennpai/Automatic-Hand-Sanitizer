	...
	; Compiler options:
	;
	; -otouchlib_6015.cof -mtouchlib_6015.map --summary=default \
	; --output=default main.p1 led.p1 uart.p1 touch_test.lpp \
	; --chip=FT62F28X -P --runtime=default --opt=default -D__DEBUG=1 -g \
